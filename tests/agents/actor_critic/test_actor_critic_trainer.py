...
from source.agents.actor_critic.actor_critic_trainer import ActorCriticTrainer
from source.env.env import Env, N_STATE_CHANNELS, N_ACTIONS
...
class TestActorCriticTrainer(unittest.TestCase):
    ...
    def test_trainer_init(self):
        ...
        self.assertEqual(trainer.trainer.max_epochs, 0)
        ...
        self.assertEqual(trainer.trainer.max_steps, 0)
